...
<head>
    ...
    <link href="{{asset("assets/stylesheets/nch-custom.css")}}?v=5.43" rel="stylesheet">
    <!-- Google Fonts -->
            ...
            <nav class="nch-nav">
                ...
                <div class="nch-nav-right">
                    ...
                    <a class="btn btn-red btn-sm nch-claim-btn" href="{{route("claim")}}">
                        <span class="nch-btn-label-full">Claims Portal</span>
                        <span class="nch-btn-label-short">Claims Portal</span>
                    </a>
