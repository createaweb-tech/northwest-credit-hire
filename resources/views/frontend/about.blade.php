        ...
        <div class="container">
            <div class="nch-split nch-split--media-r">
                ...
                <div class="nch-split__media">
                    <img src="{{asset("assets/images/cars/mercedes-e-class.jpg")}}?v=1"
                        alt="Mercedes E-Class replacement vehicle from our fleet">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="nch-section bg-dark">
        <div class="container">
            <div class="nch-statcard">
                <div>
                    <div class="n">300<span>+</span></div>
                    <div class="l">Vehicles in our fleet</div>
                </div>
                <div>
                    <div class="n">4<span>hrs</span></div>
        ...
        <div class="container">
            <div class="nch-split">
                <div class="nch-prose">
                    ...
                    <p>Northwest Credit Hire was founded on a simple premise: drivers across the North West deserve a
                        service
                        that actually shows up when it matters. Operating from two strategic sites across the UK, we've
                        built
    ...
    {{-- <section class="nch-section bg-cream">
        <div class="container">
            ...
            <div class="nch-fleet-gallery">
                ...
                <figure class="nch-fleet-gallery__item">
                    <img src="{{asset(" assets/images/cars/mercedes-g-class.jpg")}}"
                        alt="Mercedes G-Class replacement vehicle">
            ...
            <div class="nch-sec-head">
                <div class="nch-sec-head-l">
                    ...
                    <p>Many insurers offer a quick settlement that falls short of what you're genuinely owed relying
                        on the fact that most people don't know any better. <strong style="color:var(--ink);">We
                            do.</strong></p>
                </div>
            </div>
            ...
            <div class="nch-ctaband">
                <div class="nch-ctaband__inner">
                    ...
                    <div class="nch-ctaband__actions">
                        <a class="btn btn-light" href="{{route("contact")}}">Contact us <i
